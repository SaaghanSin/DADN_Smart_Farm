...
const Task = () => {
  ...
  const fetchTasks = async () => {
    try {
      const response = await fetch("http://10.0.118.54:3000/tasks");
      if (!response.ok) {
  ...
  const toggleTask = async (id, index) => {
    ...
    try {
      ...
      const response = await fetch(`http://10.0.118.54:3000/tasks/${id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const deleteTask = async (taskId, index) => {
    try {
      const response = await fetch("http://10.0.118.54:3000/deleteTask", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
