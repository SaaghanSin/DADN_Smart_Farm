...
import TemperatureChart from "./layouts/TemperatureChart";
import MoistureChart from "./layouts/MoistureChart";
import LightChart from "./layouts/LightChart";
    ...
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen
          ...
          options={headerOptions}
        />
        <Stack.Screen name="Light" component={Light} options={headerOptions} />
        <Stack.Screen
          name="Tempera"
          component={Temperature}
          options={headerOptions}
        />
        <Stack.Screen name="Task" component={Task} options={headerOptions} />
        <Stack.Screen name="Noti" component={Noti} options={headerOptions} />
        <Stack.Screen
          name="Setting"
          component={Setting}
          options={headerOptions}
        />
        <Stack.Screen name="Chart" component={Chart} options={headerOptions} />
        <Stack.Screen
